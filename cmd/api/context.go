...
// The contextSetUser() method returns a new copy of the request with provided
// User struct added in the context. Note that we use our UserContextKey constant
// as the key
